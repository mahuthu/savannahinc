...
const Services = () => {
    ...
    useEffect(() => {
        const elements = Array.from(document.querySelectorAll(`.${styles.serviceIconContainer}`));
    ...
    return (
        ...
        >
            <div className={styles.servicesOverlay}>
                ...
                <p className={styles.servicesHead}>
                    Our solutions are designed to help you achieve your business goals. Our culture is to satisfy our client's needs by offering customized solutions that are in line with the latest technology and best IT practices.
                </p>
                <div className={styles.servicesGrid}>
                    {services.map((service, index) => (
                        <Link
                            key={index}
                            to={service.route}
                            className={`${styles.serviceIconContainer} ${styles['initial-hidden']} ${index % 2 === 0 ? styles['delay-1'] : styles['delay-2']}`} // Add delay class based on index
                        >
